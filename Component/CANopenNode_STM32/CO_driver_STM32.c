...
//230725
extern CO_CANrx_t TPDO_Rx_buffer;
...
#endif
{
    ...
    //230725
    if (((rcvMsgIdent ^ TPDO_Rx_buffer.ident) & TPDO_Rx_buffer.mask) == 0U) {
    	TPDO_Rx_buffer.CANrx_callback(buffer->object, (void*)&rcvMsg);
	}
}
 ...
 */
void
HAL_CAN_RxFifo0MsgPendingCallback_CO(CAN_HandleTypeDef* hcan) {
